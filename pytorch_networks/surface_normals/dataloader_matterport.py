...
class SurfaceNormalsDataset(Dataset):
    ...
    def __init__(self,
                 input_dir='/home/gani/deeplearning/brain/datasets/matterport3d/matterport_rgb/v1/scans/',
                 label_dir='/home/gani/deeplearning/brain/datasets/matterport3d/matterport_render_normal',
                 transform=None,
                 input_only=None,
                 ):
